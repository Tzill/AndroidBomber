...
public class GameScreen implements Screen {
    ...
    public void update(float dt) {
        ...
        if (Gdx.input.isKeyJustPressed(Input.Keys.F)) {
            if (currentStatus == Status.PAUSE)  currentStatus = Status.PLAY;
            else currentStatus = Status.PAUSE;
    ...
    public void createGUI() {
        ...
        if (Gdx.app.getType() == Application.ApplicationType.Desktop) {
            ...
            Button buttonPause = new Button(skin.getDrawable("pause"));
            buttonPause.setPosition(1100, 150);
            ...
            Button buttonMenu = new Button(skin.getDrawable("menu"));
            buttonMenu.setPosition(1100, 250);
